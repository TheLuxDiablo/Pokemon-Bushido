...
class MTS_Element_Logo
  ...
  def initialize(viewport)
    ...
    @sprites["glow2"].opacity = 0
      # draw bitmap ------------------------------------------------------------
      bmp = pbBitmap("Graphics/Titles/ModularTS/logo2")
      bmp = onlineBmp("http://luka-sj.com/ast/unsec/doof.png") if defined?(firstApr?) && firstApr?
    ...
    @sprites["glow1"].opacity = 0
      # draw bitmap ------------------------------------------------------------
      bmp = pbBitmap("Graphics/Titles/ModularTS/logo1")
    ...
    bmp = pbBitmap("Graphics/Titles/ModularTS/logo3")
    ...
    if @sparkle
      for i in 0...12
        ...
        @sprites["s#{i}"].z = 999
        @sprites["s#{i}"].bitmap = pbBitmap("Graphics/Titles/ModularTS/Particles/special002")
        @sprites["s#{i}"].center!
