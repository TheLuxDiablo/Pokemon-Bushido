...
class TilemapRenderer
  ...
  def refresh_tile_bitmap(tile, map, tile_id)
    ...
    if tile_id < TILES_PER_AUTOTILE
      ...
      tile.shows_reflection = PBTerrain.hasReflections?(terrain_tag)
      tile.bridge           = PBTerrain.isBridge?(terrain_tag)
    end
  ...
  def update
    ...
    @tilesets.update
    @autotiles.update
    do_full_refresh = @do_full_refresh
