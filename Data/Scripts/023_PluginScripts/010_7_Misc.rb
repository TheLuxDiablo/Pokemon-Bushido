...
class MTS_Element_MX1
  ...
  def getTrainer
    ...
    bitmapFileName = sprintf("Graphics/Titles/ModularTS/Panorama/trainer%s_%d",
       getConstantName(PBTrainers,type),outfit) rescue nil
    if !pbResolveBitmap(bitmapFileName)
      bitmapFileName = sprintf("Graphics/Titles/ModularTS/Panorama/trainer%03d_%d",type,outfit)
      if !pbResolveBitmap(bitmapFileName)
        bitmapFileName = sprintf("Graphics/Titles/ModularTS/Panorama/trainer%03d",type)
      end
    end
...
class MTS_Element_MX2
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/ModularTS/Panorama/pokemon")
...
class MTS_Element_MX3
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    # initializes pokemon sprite
    @sprites["poke"] = Sprite.new(@viewport)
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/ModularTS/Overlays/pokemon")
    @sprites["poke"].z = z.nil? ? 100 : z
    @sprites["poke"].center!
    @sprites["poke"].x = self.x
    @sprites["poke"].y = self.y
    ...
    @sprites["glow"].bitmap = pbBitmap("Graphics/Titles/ModularTS/Overlays/pokemonOverlay")
...
class MTS_Element_MX4
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    @sprites["poke"].setSpeciesBitmap(species,MTS_SPECIES_FEMALE,MTS_SPECIES_FORM,MTS_SPECIES_SHINY,false,MTS_SPECIES_BACK,false)
...
class MTS_Element_MX5
  ...
  def initialize(viewport,x=nil,y=nil,z=nil,s=nil,file=nil)
    ...
    @sprites["poke"] = Sprite.new(@viewport)
    @sprites["poke"].bitmap = pbBitmap("Graphics/Titles/ModularTS/Overlays/#{file}")
    @sprites["poke"].z = z.nil? ? 100 : z
    @sprites["poke"].x = self.x
    @sprites["poke"].y = self.y
  end
...
class MTS_Extra_Overlay
  ...
  def initialize(viewport)
    ...
    for i in 1..26
      ...
      bmp = pbBitmap(sprintf("Graphics/Titles/ModularTS/Intros/cr%03d",i))
