...
def pbMountBike(*args)
  ...
  bike_anim = pbGetMetadata(mapid, MetadataBicycle)
...
class PokemonLoadScreen
  alias __followingpkmn__pbStartLoadScreen pbStartLoadScreen unless method_defined?(:__followingpkmn__pbStartLoadScreen)
  def pbStartLoadScreen(*args)
    __followingpkmn__pbStartLoadScreen(*args)
    FollowingPkmn.refresh(false)
  end
end
