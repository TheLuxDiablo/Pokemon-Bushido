...
ItemHandlers::CanUseInBattle.copy(:PARALYZEHEAL,:CHERIBERRY)
...
ItemHandlers::CanUseInBattle.copy(:XDEFENSE,:XDEFENSE2,:XDEFENSE3,:XDEFENSE6)
...
ItemHandlers::CanUseInBattle.copy(:XSPATK,:XSPATK2,:XSPATK3,:XSPATK6)
...
ItemHandlers::BattleUseOnPokemon.copy(:PARALYZEHEAL,:CHERIBERRY)
